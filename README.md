...
- **Super-Loop Main**: Predictable control flow (common in safety-critical systems)
- **Software Watchdog**: Timeout detection and recovery (FDIR)
- **Memory Scrub**: Periodic EDAC-style error detection/correction against golden copy
