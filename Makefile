...
CSRC = src/main.c src/system.c src/uart.c src/string.c src/watchdog.c src/memory_scrub.c \
       src/fault_inject.c src/fault_queue.c src/isr_stack_guard.c src/telemetry.c \
       src/timer.c src/interrupt.c \
       $(FREERTOS_SRC)
ASRC = src/startup.s
OBJ = $(ASRC:.s=.o) \
